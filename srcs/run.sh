...
echo "CREATE USER IF NOT EXISTS 'seujeong'@'localhost' IDENTIFIED BY 'Jsh!88948748';" \
	| mysql -u root --skip-password
echo "GRANT ALL PRIVILEGES ON wordpress.* TO 'seujeong'@'localhost' WITH GRANT OPTION;" \
	| mysql -u root --skip-password
